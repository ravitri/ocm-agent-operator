...
import (
	...
	"github.com/openshift/ocm-agent-operator/pkg/cli/consts"
	"github.com/openshift/ocm-agent-operator/pkg/cli/ocm"
	...
	"github.com/openshift/ocm-agent-operator/pkg/cli/config"
	"github.com/openshift/ocm-agent-operator/pkg/cli/handlers"
	"github.com/openshift/ocm-agent-operator/pkg/cli/k8s"
	"github.com/openshift/ocm-agent-operator/pkg/cli/logging"
	"github.com/openshift/ocm-agent-operator/pkg/cli/metrics"
